...
def parse_args():
    ...
    parser.add_argument(
        ...
        required=False,
        # default="./configs/ABD_cifar10.yaml",
        default="./configs/ABD_cifar100.yaml",
        # default="./configs/ABD_tiny.yaml",
        # default="./configs/ABD_imagenet.yaml",
        type=str,
    )
    parser.add_argument(
        "opts",
...
if __name__ == "__main__":
    ...
    if ABD_cfg.seed == 10:
        if "CIFAR100" == ABD_cfg.DATASET.dataset_name:
            order_class_list = [19, 14, 43, 37, 66, 3, 79, 41, 38, 68, 2, 1, 60, 53, 95, 74, 92, 26, 59, 46, 90, 70, 50, 44,
                                ...
                                64,
                                15, 9]
        elif "CIFAR10" == ABD_cfg.DATASET.dataset_name:
            order_class_list = [8, 2, 5, 6, 3, 1, 0, 7, 4, 9]
        elif "tiny" in ABD_cfg.DATASET.dataset_name:
            ...
            raise ValueError(f"ABD_cfg.DATASET.dataset_name")
    elif ABD_cfg.seed == 100:
        if "CIFAR100" == ABD_cfg.DATASET.dataset_name:
    ...
    # split_seleted_data = {0: [52, 1, 30, 96], 1: [4, 5, 6, 7], 2: [8, 9, 10, 11], 3: [12, 13, 14, 15], 4: [16, 17, 18, 19], 5: [20, 21, 22, 23], 6: [24, 25, 26, 27], 7: [28, 29, 2, 31], 8: [32, 33, 34, 35], 9: [36, 37, 38, 39], 10: [40, 41, 42, 43], 11: [44, 45, 46, 47], 12: [48, 49, 50, 51], 13: [0, 53, 54, 55], 14: [56, 57, 58, 59], 15: [60, 61, 62, 63], 16: [64, 65, 66, 67], 17: [68, 69, 70, 71], 18: [72, 73, 74, 75], 19: [76, 77, 78, 79], 20: [80, 81, 82, 83], 21: [84, 85, 86, 87], 22: [88, 89, 90, 91], 23: [92, 93, 94, 95], 24: [3, 97, 98, 99]}
    split_seleted_data = split_classes_per_task(order_class_list, tasks=ABD_cfg.DATASET.all_tasks)
    ...
    midfcl_handler = MI_DFCL_handler(dataset_split_handler, ABD_cfg, logger)
